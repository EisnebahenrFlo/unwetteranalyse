...
describe("mapBrightSkyAlerts", () => {
  it("liest CAP-severity-String und setzt warnLevel korrekt", () => {
    const [a] = mapBrightSkyAlerts({
      alerts: [{
        alert_id: "x1", severity: "severe", event_de: "GEWITTER",
        headline_de: "Amtliche UNWETTERWARNUNG", description_de: "d",
        onset: "2026-06-25T10:00:00+00:00", expires: "2026-06-25T14:00:00+00:00",
      }],
    });
