...
export const WIND_GUST_RULES: ThresholdRule[] = [
  r({
    id: "wind-minor",
    parameter: "windGust",
    label: "Wind- bis stürmische Böen (50–74 km/h, Bft 7–8)",
    explain:
  ...
  r({
    id: "wind-moderate",
    parameter: "windGust",
    label: "Sturmböen (75–102 km/h, Bft 9–10)",
  ...
  r({
    id: "wind-severe",
    parameter: "windGust",
    label: "Schwere Sturm- bis Orkanböen (103–140 km/h, Bft 11–12)",
  ...
  r({
    id: "wind-extreme",
    parameter: "windGust",
    label: "Extreme Orkanböen (≥ 140 km/h)",
...
export const PRECIP_RULES: ThresholdRule[] = [
  r({
    id: "rain-minor",
    parameter: "precip1h",
    label: "Starkregen markant (15–25 mm/h)",
  ...
  r({
    id: "rain-moderate",
    parameter: "precip1h",
    label: "Heftiger Starkregen (25–40 mm/h)",
...
export const CAPE_RULES: ThresholdRule[] = [
  ...
  r({
    id: "cape-severe",
    parameter: "cape",
    label: "Sehr hohe Labilität (≥ 2500 J/kg)",
    explain: "Unwetterpotenzial nur mit zusätzlicher Auslöse-/Scherungslage.",
    severity: "moderate",
    evaluate: (v) => v >= 2500,
    reason: (v) => `CAPE um ${v.toFixed(0)} J/kg.`,
    unit: "J/kg",
