...
export function DailyStrip({ bundle }: { bundle: ForecastBundle }) {
  ...
  return (
    <DataCard title="7-Tage Trend" subtitle="Inklusive Gewitter- und Unwettersignal pro Tag." meta={bundle.meta}>
      <div className="flex flex-col">
        {days.map((d) => {
          ...
          return (
            <div key={d.date} className="grid grid-cols-[132px_auto_minmax(0,1fr)_70px] items-center gap-3 border-b border-border/50 py-2 last:border-0">
              ...
              <div className="min-w-[80px]">
                {severity.level !== "none"
                  ...
                  : <span className="inline-flex items-center rounded-md border border-border bg-background/60 px-2 py-0.5 text-[10px] uppercase tracking-wide text-muted-foreground">ruhig</span>
                }
              </div>
